...
def _normalize_model_definition_to_experiment(model_definition_full: dict[str, Any], experiment: dict[str, Any]) -> dict[str, Any]:
    if not isinstance(model_definition_full, dict):
...
def execute_validate_candidate(payload: dict) -> dict:
    ...
    original_model_definition = dict(model_definition_full)
    ...
    if repaired_model_definition_full is not None:
        ...
        result["repaired_model_definition_full"] = model_definition_full
    report_progress({
