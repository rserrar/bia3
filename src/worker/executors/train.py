...
def _resolve_training_config(payload: dict[str, Any], settings: Any) -> dict[str, Any]:
    ...
    return {
        ...
        "business_metric_sl_weight": max(0.0, _pick_float("business_metric_sl_weight", settings.train_business_metric_sl_weight)),
        "business_metric_tb_weight": max(0.0, _pick_float("business_metric_tb_weight", settings.train_business_metric_tb_weight)),
        "business_min_relative_improvement": max(0.0, _pick_float("business_min_relative_improvement", settings.train_business_min_relative_improvement)),
        "business_improvement_window": max(2, _pick_int("business_improvement_window", settings.train_business_improvement_window)),
        "soft_max_epochs": max(0, _pick_int("soft_max_epochs", settings.train_soft_max_epochs)),
    }
    ...
    if model_definition_full:
        try:
            ...
            full_fit = run_full_fit_real_data(
                ...
                business_metric_sl_weight=resolved["business_metric_sl_weight"],
                business_metric_tb_weight=resolved["business_metric_tb_weight"],
                business_min_relative_improvement=resolved["business_min_relative_improvement"],
                business_improvement_window=resolved["business_improvement_window"],
                soft_max_epochs=resolved["soft_max_epochs"],
            ...
            training_stats_extra = {
                ...
                "business_metric_sl_weight": float(resolved["business_metric_sl_weight"]),
                "business_metric_tb_weight": float(resolved["business_metric_tb_weight"]),
                "business_min_relative_improvement": float(resolved["business_min_relative_improvement"]),
                "business_improvement_window": int(resolved["business_improvement_window"]),
                "soft_max_epochs": int(resolved["soft_max_epochs"]),
                "target_metric_value": float(full_fit.get("target_metric_value", full_fit.get("best_val_loss", training_kpis["val_loss"]))),
                "cache_dtype": settings.data_cache_dtype,
